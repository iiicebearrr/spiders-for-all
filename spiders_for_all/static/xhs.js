  ...
  function Sanji() {
    ...
    return function (_ace_4752e, _ace_aa949, _ace_be07c) {
      ...
      var _ace_8cba0 = function (_ace_0a916) {
        try {
          return _ace_0a916._ace_38c9c
            ? _ace_0a916._ace_936[_ace_0a916._ace_47589]
            : _ace_0a916._ace_4de55;
        } catch (e) {
          return _ace_0a916._ace_38c9c
            ? window[_ace_0a916._ace_47589]
            : _ace_0a916._ace_4de55;
        }
      };
      ...
      var _ace_c7cc7 = function () {
        _ace_0edd5.push(
          _ace_b81ca(_ace_6458, _ace_c9a41, _ace_c9a41, _ace_c9a41)
        );
      };
      ...
      var _ace_dcca5 = [
        _ace_b81ca(_ace_c9a41, _ace_c9a41, _ace_c9a41, _ace_c9a41),
        _ace_b81ca(_ace_c9a41, _ace_c9a41, _ace_c9a41, _ace_c9a41),
        _ace_b81ca(_ace_c9a41, _ace_c9a41, _ace_c9a41, _ace_c9a41),
        _ace_b81ca(_ace_c9a41, _ace_c9a41, _ace_c9a41, _ace_c9a41),
        _ace_b81ca(_ace_c9a41, _ace_c9a41, _ace_c9a41, _ace_c9a41),
      ...
      var _ace_4d11 = [
        _ace_be07c,
        function _ace_ad126(_ace_5ed3b) {
          return _ace_dcca5[_ace_5ed3b];
        },
        function (_ace_5ed3b) {
          return _ace_b81ca(
            _ace_c9a41,
            _ace_420ea._ace_b0594,
            _ace_5ed3b,
            _ace_a72ba
          );
        },
        ...
        function (_ace_5ed3b) {
          return _ace_b81ca(
            _ace_c9a41,
            _ace_4752e,
            _ace_aa949.d[_ace_5ed3b],
            _ace_a72ba
          );
        },
        function (_ace_5ed3b) {
          return _ace_b81ca(
            _ace_420ea._ace_5ee37,
            _ace_c9a41,
            _ace_c9a41,
            _ace_c9a41
          );
      ...
      var _ace_ae44 = function (_ace_28434, _ace_5ed3b) {
        return _ace_4d11[_ace_28434]
          ? _ace_4d11[_ace_28434](_ace_5ed3b)
          : _ace_b81ca(_ace_c9a41, _ace_c9a41, _ace_c9a41, _ace_c9a41);
      };
      var _ace_34d1 = function (_ace_28434, _ace_5ed3b) {
        return _ace_8cba0(_ace_ae44(_ace_28434, _ace_5ed3b));
      };
      var _ace_1ae3c = function (
        _ace_d656a,
        _ace_7e97a,
        _ace_5ed3b,
        _ace_0a916
      ) {
        _ace_dcca5[_ace_c9a41] = _ace_b81ca(
          _ace_d656a,
          _ace_7e97a,
          _ace_5ed3b,
          _ace_0a916
      ...
      var _ace_ea2b3 = function (_ace_d939, _ace_2d9a) {
        ...
        return _ace_0c1a0[5]._ace_4de55 > _ace_d939
          ? _ace_0c1a0[5]._ace_4de55
          : _ace_d939;
      };
      var _ace_75a05 = decode(_ace_aa949.b)
        .split("")
        .reduce(function (_ace_664b, _ace_b34db) {
          if (
            !_ace_664b.length ||
            _ace_664b[_ace_664b.length - _ace_a72ba].length == 5
          ) {
            _ace_664b.push([]);
          }
          _ace_664b[_ace_664b.length - _ace_a72ba].push(
            -_ace_a72ba * 1 + _ace_b34db.charCodeAt()
          );
          return _ace_664b;
        }, []);
      var _ace_aec23 = [
        function (p0, p1, p2, p3, p4, p5, p6) {
          _ace_1ae3c(
            _ace_34d1(p0, p1) / _ace_34d1(p2, p3),
            _ace_be07c,
            _ace_be07c,
            0
          );
        ...
        function (p0, p1, p2, p3, p4, p5, p6) {
          ...
          _ace_1ae3c(
            _ace_a3718
              .splice(_ace_a3718.length - _ace_2c526, _ace_2c526)
              .map(_ace_8cba0),
            _ace_be07c,
            _ace_be07c,
            0
        ...
        function (p0, p1, p2, p3, p4, p5, p6) {
          var _ace_25a6 = _ace_ae44(p0, p1);
          _ace_1ae3c(
            delete _ace_25a6._ace_936[_ace_25a6._ace_47589],
            _ace_be07c,
            _ace_be07c,
            0
          );
        ...
        function (p0, p1, p2, p3, p4, p5, p6) {
          ...
          var _ace_bdcc = _ace_a3718
              .splice(_ace_a3718.length - _ace_163c1, _ace_163c1)
              .map(_ace_8cba0),
            _ace_25a6 = _ace_a3718.pop(),
            _ace_8712 = _ace_8cba0(_ace_25a6);
          _ace_bdcc.unshift(null);
          _ace_1ae3c(
            new (Function.prototype.bind.apply(_ace_8712, _ace_bdcc))(),
            _ace_be07c,
            _ace_be07c,
            0
          );
        ...
        function (p0, p1, p2, p3, p4, p5, p6) {
          _ace_1ae3c(
            _ace_34d1(p0, p1) instanceof _ace_34d1(p2, p3),
            _ace_be07c,
            _ace_be07c,
            0
          );
        ...
        function (p0, p1, p2, p3, p4, p5, p6) {
          var _ace_88c3 = _ace_34d1(p0, p1),
            _ace_d2389 = {};
          _ace_1ae3c(
            _ace_01154(_ace_88c3, _ace_d2389),
            _ace_be07c,
            _ace_be07c,
            0
          );
        ...
        function (p0, p1, p2, p3, p4, p5, p6) {
          _ace_1ae3c(
            _ace_34d1(p0, p1) in _ace_34d1(p2, p3),
            _ace_be07c,
            _ace_be07c,
            0
          );
        ...
        function (p0, p1, p2, p3, p4, p5, p6) {
          ...
          _ace_1ae3c(
            _ace_8712.apply(
              typeof _ace_25a6._ace_936 == "undefined"
                ? _ace_4752e
                : _ace_25a6._ace_936,
              _ace_bdcc
            ),
        ...
        function (p0, p1, p2, p3, p4, p5, p6) {
          ...
          if (
            _ace_d2389 &&
            typeof _ace_d2389 === "object" &&
            _ace_d2389.hasOwnProperty("appId")
          ) {
          ...
          if (
            _ace_d2389 &&
            typeof _ace_d2389 === "object" &&
            _ace_d2389.hasOwnProperty("signVersion")
          ) {
          ...
          if (_ace_d2389 && Array.isArray(_ace_d2389)) {
            ...
            if (
              ...
              lastElement.hasOwnProperty("key") &&
              lastElement.key === "x2"
            ) {
              _ace_d2389[_ace_d2389.length - 3].value =
          ...
          if (_ace_25a6._ace_47589 === "_webmsxyw") {
            _ace_1ae3c(
              (window[_ace_25a6._ace_47589] = _ace_d2389),
              _ace_be07c,
              _ace_be07c,
              0
            );
        ...
        ,
        function (p0, p1, p2, p3, p4, p5, p6) {
          var _ace_404c = _ace_75a05.slice(
              _ace_34d1(p0, p1),
              _ace_34d1(p2, p3) + 1
            ),
            _ace_71423 = _ace_66;
